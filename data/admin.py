...
class AttendanceAdmin(RollNoSearch, admin.ModelAdmin):
    search_fields = [
        "studentsemesterrecord__student__enrolment_no",
        "studentsemesterrecord__roll_no",
        "studentsemesterrecord__student__email",
        "date",
    ]
...
class RemedialTestResultAdmin(admin.ModelAdmin):
    search_fields = [
        "testresult__subject__subject_code",
        "testresult__subject__subject_short_name",
        "testresult__studentsemesterrecord__student__enrolment_no",
    ]
...
class StudentSemesterRecordAdmin(SemesterSearch, admin.ModelAdmin):
    search_fields = [
        ...
        "roll_no",
        "department__semester",
        "department__batch__name",
        "department__branch__branch_short_name",
        "department__year",
    ]
